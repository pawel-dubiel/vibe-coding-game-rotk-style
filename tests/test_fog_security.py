...
class TestFogSecurity:
    ...
    def test_hidden_enemy_click_shows_terrain_not_unit(self):
        ...
        visibility = game_state.fog_of_war.get_visibility_state(1, 10, 10)
        ...
        assert knight_at_pos.player_id == 2  # It's an enemy
    ...
    def test_visible_enemy_click_shows_unit_info(self):
        ...
        visibility = game_state.fog_of_war.get_visibility_state(1, 6, 5)
    ...
    def test_renderer_doesnt_draw_hidden_units(self):
        ...
        for enemy in game_state.knights:
            if enemy.player_id == 2:
                visibility = game_state.fog_of_war.get_visibility_state(1, enemy.x, enemy.y)
    ...
    def test_ai_respects_fog_of_war(self):
        ...
        # Clear default castles to avoid interference
        game_state._castles = []
        ...
        # Update fog of war
        game_state.fog_of_war.update_player_visibility(game_state, 2)
        
        # Get visible enemies for AI (player 2)
        visible_units = game_state.fog_of_war.get_visible_units(game_state, 2)
        enemy_units = [u for u in visible_units if u.player_id == 1]
